...
extra_vars_to_drop <- list(Argentina = c("m2", "ri", "p_import", "", "", "", "", "", "", "", ""), 
                           Bolivia = c("igae", "", "", "", "", "", "", "", "", "", "", ""), 
                           Brasil = c("", "", "", "", "", "", "", "", "", "", "", ""), 
                           Chile = c("", "", "", "", "", "", "", "", "", "", "", ""), 
                           Colombia = c("", "", "", "", "", "", "", "", "", "", "", ""), 
...
models_and_accu_12 <- rbind(models_and_accu_1, models_and_accu_2) %>% 
...
# saveRDS(models_and_accu, "./data/col_ma_long_bt12.rds")
