...
# this_bt = 1.3 test. 46.7845 minutes
...
# all VARs size 2, 0.4055 minutes
tictoc::tic()
...
# all VARs size 3, 4.572167 mintutes
tictoc::tic()
...
# all VARs size 4, 2 choices of lag,27.139 min
...
# or 1 pre_chosen, size 4, 3 choices of lag, 3.993333 minutes
...
# plus 1 pre_chosen, size 5, 1 lag 13.47933 min
...
saveRDS(models_and_accu_12345, "./data/Par_by_step_12345.rds")
