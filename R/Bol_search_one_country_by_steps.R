...
# Based one_time bt test, I choose manuf and hidrocarburo as the preset variable for length 5 vars and lag = 3
...
var_res_5 <- try_sizes_vbls_lags(vec_size = 5, 
                                 ...
                                 level_data = level_data_ts, 
                                 target_v = target_rgdp,
                                 pre_selected_v = c("manuf", "hidrocarburo"), 
                                 is_cv = TRUE,
                                 training_length = train_span,
                                 h_max = fc_horizon, n_cv = number_of_cv,
                                 bt_factor = 0, maxlag_ccm = 8,
...
saveRDS(cv_objects_12345, "./data/Bol_by_step_12345_cv_objects.rds")

# cv_errors <- cv_objects_12345[["cv_errors"]]


# mutate(cv_errors = unlist(cv_errors))
...
#   saveRDS(cv_objects, "./data/Bol_by_step_12345_cv_objects.rds")
# }
