...
# this_bt = 1.3 test. 16.1725 minutes
...
var_res_5 <- try_sizes_vbls_lags(vec_size = 5, 
                                 ...
                                 level_data = level_data_ts, 
                                 target_v = target_rgdp,
                                 pre_selected_v = c("ip_sales", "exp_notradictional"), 
                                 is_cv = TRUE,
                                 training_length = train_span,
                                 h_max = fc_horizon, n_cv = number_of_cv,
                                 bt_factor = 0, maxlag_ccm = 8,
...
saveRDS(models_and_accu_12345, "./data/Col_by_step_12345.rds")
...
saveRDS(cv_objects_12345, "./data/Col_by_step_12345_cv_objects.rds")
